...
def install(overwrite=True):
    ...
    with open("/opt/retropie/configs/all/emulationstation/scripts/system-select/update_notification.sh", "w") as shellfile:
        ...
        shellfile.write("    convert -background Red -fill White -font /usr/share/fonts/truetype/freefont/FreeSansBold.ttf -gravity center -size $((png_width))x$((png_height)) label:\"UPDATES AVAILABLE\" /home/pi/.update_tool/update_available.png\n")
        shellfile.write("    timeout 20 /home/pi/.update_tool/pngview -b 0 -l 1 -x $((screen_width-png_width)) -y 0 /home/pi/.update_tool/update_available.png &\n")
        shellfile.write("  fi\n")
        shellfile.write("fi\n")
