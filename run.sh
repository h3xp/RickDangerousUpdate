...
'
sudo apt-get -y install python3-pip && git clone https://github.com/h3xp/RickDangerousUpdate && cd RickDangerousUpdate && pip3 install -r requirements.txt && python3 update.py